...
router.post('/:dbName/query', requireAuth, asyncHandler(async (req, res) => {
...
router.post('/:dbName/query/explain', requireAuth, asyncHandler(async (req, res) => {
    const { dbName } = req.params;
...
router.post('/:dbName/query/export/csv', requireAuth, asyncHandler(async (req, res) => {
    const { dbName } = req.params;
    const { sql } = req.body;
    if (!isSafeIdentifier(dbName)) {
        throw new ValidationError('Invalid database name');
...
router.get('/:dbName/query/history', requireAuth, asyncHandler(async (req, res) => {
    const { dbName } = req.params;
...
router.get('/:dbName/query/history/:queryId', requireAuth, asyncHandler(async (req, res) => {
...
router.delete('/:dbName/query/history', requireAuth, asyncHandler(async (req, res) => {
    const { dbName } = req.params;
    if (!isSafeIdentifier(dbName)) {
        throw new ValidationError('Invalid database name');
    }
