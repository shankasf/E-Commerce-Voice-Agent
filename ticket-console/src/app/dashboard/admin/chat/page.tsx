    ...
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      <header className="bg-purple-600 text-white shrink-0">
        <div className="px-4 py-4">
          ...
          <h1 className="text-xl font-bold">AI Admin Assistant</h1>
          <p className="text-sm text-purple-200 mt-1">
            Administrative AI assistant for system management and diagnostics
          </p>
        </div>
      </header>
      ...
      >
        ...
        {isTerminalOpen && (
          <div
            ...
            className="w-1 bg-gray-300 hover:bg-purple-500 cursor-col-resize transition-colors shrink-0"
