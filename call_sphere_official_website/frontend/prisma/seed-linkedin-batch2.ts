...
import { linkedInPostsBatch2 } from "../content/blog/linkedin-newsletter-batch2";
...
async function main() {
  ...
  let seeded = 0;
  for (const post of linkedInPostsBatch2) {
  ...
  console.log(`\nSeeded ${seeded} blog posts (batch 2) successfully.`);
}
