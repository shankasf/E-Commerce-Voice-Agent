...
class Config:
    ...
    # Next.js API Gateway
    nextjs_api_url: str = field(default_factory=lambda: os.getenv("NEXTJS_API_URL", "http://localhost:3001"))
    nextjs_api_key: str = field(default_factory=lambda: os.getenv("NEXTJS_API_KEY", ""))

    # Applications Backend (for remote troubleshooting)
    applications_backend_url: str = field(default_factory=lambda: os.getenv("APPLICATIONS_BACKEND_URL", "http://localhost:9000"))
    applications_backend_api_key: str = field(default_factory=lambda: os.getenv("APPLICATIONS_BACKEND_API_KEY", ""))
